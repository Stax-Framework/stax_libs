...
function Camera:SetActiveInterp(camFrom, camTo, duration, easeLocation, easeRotation)
  SetCamActiveWithInterp(camTo.Handle, camFrom.Handle, duration, easeLocation, easeRotation)
end
...
function Camera:ShakeAmplitute(amplitude)
...
function Camera:AddSplineNode(position, rotation, length, slowness, transitionType)
  AddCamSplineNode(self.Handle, float* x, float* y, float* z, float* xRot, float* yRot, float* zRot, int* length, int* p8, int* transitionType)
end
